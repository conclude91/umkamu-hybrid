...
/*final Color secondaryColor = Color(0xFFFC5C65);
final Color primaryColor = Color(0xFF03A9F4);*/
final Color accentColor = Color(0xFF66bb6a);
final Color transparent = Colors.transparent;
final Color shadow = Color(0xFFE9EBEE);
final Color gold = Color(0xFFFF8C00);
final String primaryColorHex = '#FC5C65';
final String secondaryColorHex = '#03A9F4';
final String primaryContentColorHex = '#0C1821';
final String secondaryContentColorHex = '#FCFFFD';
final String primaryFont = 'Roboto';
final String secondaryFont = 'Basketball';
final FontWeight fontBold = FontWeight.w900;
final double microSize = 11;
